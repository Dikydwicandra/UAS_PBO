...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setBounds(440, 60, 80, 21);
        ...
        txtUsername.setBounds(440, 130, 140, 22);
        ...
        txtPassword.setBounds(440, 170, 140, 22);
        ...
        btnLogin.setBounds(460, 220, 90, 30);
        ...
        jLabel7.setText("SISTEM PENDATAAN SEPATU SPORT");
        ...
        jLabel9.setFont(new java.awt.Font("Times New Roman", 0, 8)); // NOI18N
        jLabel9.setText("Silahkan masukkan username dan password !!!");
        getContentPane().add(jLabel9);
        jLabel9.setBounds(410, 91, 150, 20);
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
       try{
           String sql = "SELECT * FROM tbakun1 WHERE Username=('"+txtUsername.getText()+"')AND Password=('"+txtPassword.getText()+"')";
